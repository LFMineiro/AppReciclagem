...
const CollectOrgScreen = () => {
    const [filteredData, setFilteredData] = useState([]);

  useEffect(() => {
    const coletaItems = filtersData.filter(item => item.Modalidade.includes('Coleta'))
    setFilteredData(coletaItems);
  }, []);
...
export default CollectOrgScreen
